...
pub mod mock {
    ...
    // ✅ ADD THIS HERE — in the mock module, not the real FFI block!
    pub unsafe fn ANativeWindow_fromSurface(
        _env: *mut c_void,
        surface: *mut c_void,
    ) -> *mut ANativeWindow {
        surface as *mut ANativeWindow
    }

    pub unsafe fn ANativeWindow_acquire(_: *mut ANativeWindow) {}
    pub unsafe fn ANativeWindow_release(_: *mut ANativeWindow) {}
    pub unsafe fn ANativeWindow_getWidth(_: *mut ANativeWindow) -> c_int {
        MOCK_W.load(Ordering::Relaxed)
    }
    pub unsafe fn ANativeWindow_getHeight(_: *mut ANativeWindow) -> c_int {
        MOCK_H.load(Ordering::Relaxed)
    }
    ...
    pub unsafe fn AInputQueue_getEvent(_: *mut AInputQueue, _: *mut *mut c_void) -> c_int {
        0
    }
    pub unsafe fn AInputQueue_preDispatchEvent(_: *mut AInputQueue, _: *mut c_void) -> c_int {
        0
    }
    ...
    pub unsafe fn AInputEvent_getType(_: *const c_void) -> c_int {
        AINPUT_EVENT_TYPE_MOTION
    }
    pub unsafe fn AInputEvent_getDeviceId(_: *const c_void) -> c_int {
        0
    }
    pub unsafe fn AInputEvent_getSource(_: *const c_void) -> c_int {
        0
    }

    pub unsafe fn AMotionEvent_getAction(_: *const c_void) -> c_int {
        AMOTION_EVENT_ACTION_DOWN
    }
    pub unsafe fn AMotionEvent_getX(_: *const c_void, _: usize) -> f32 {
        100.0
    }
    pub unsafe fn AMotionEvent_getY(_: *const c_void, _: usize) -> f32 {
        200.0
    }
    pub unsafe fn AMotionEvent_getPointerCount(_: *const c_void) -> usize {
        1
    }
    pub unsafe fn AMotionEvent_getPointerId(_: *const c_void, _: usize) -> c_int {
        0
    }
    pub unsafe fn AMotionEvent_getEventTime(_: *const c_void) -> i64 {
        0
    }

    pub unsafe fn AKeyEvent_getAction(_: *const c_void) -> c_int {
        0
    }
    pub unsafe fn AKeyEvent_getKeyCode(_: *const c_void) -> c_int {
        0
    }
    pub unsafe fn AKeyEvent_getMetaState(_: *const c_void) -> c_int {
        0
    }
    ...
    pub unsafe fn ALooper_addFd(
        ...
        _: c_int,
        _: c_int,
        _: Option<unsafe extern "C" fn(c_int, c_int, *mut c_void) -> c_int>,
        _: *mut c_void,
    ) -> c_int {
        1
    }
    pub unsafe fn ALooper_removeFd(_: *mut ALooper, _: c_int) -> c_int {
        1
    }
    ...
    pub unsafe fn AChoreographer_getInstance() -> *mut AChoreographer {
        core::ptr::null_mut()
    }
    pub unsafe fn AChoreographer_postFrameCallback(
        _: *mut AChoreographer,
        _: Option<unsafe extern "C" fn(i64, *mut c_void)>,
        _: *mut c_void,
    ) {
    }

    pub unsafe fn __android_log_write(_: c_int, _: *const c_char, _: *const c_char) -> c_int {
        0
    }
}
...
impl NativeWindow {
    pub unsafe fn from_raw(ptr: *mut ANativeWindow) -> Option<Self> {
        ...
        Some(Self {
            ptr,
            width: ANativeWindow_getWidth(ptr),
            height: ANativeWindow_getHeight(ptr),
        })
    }
    ...
    pub unsafe fn as_raw(&self) -> *mut ANativeWindow {
        self.ptr
    }
}
...
impl Drop for NativeWindow {
    fn drop(&mut self) {
        unsafe {
            ANativeWindow_release(self.ptr);
        }
    }
}
...
impl InputEventHandle {
        ...
        unsafe {
            match AInputEvent_getType(self.raw) {
                AINPUT_EVENT_TYPE_MOTION => InputEvent::Motion {
                    ...
                    pos: Vec2::new(
                        AMotionEvent_getX(self.raw, 0),
                        AMotionEvent_getY(self.raw, 0),
                    ),
    ...
    pub fn finish(self, handled: bool) {
        unsafe {
            AInputQueue_finishEvent(self.queue, self.raw, if handled { 1 } else { 0 });
        }
...
impl Drop for InputEventHandle {
    fn drop(&mut self) {
        unsafe {
            AInputQueue_finishEvent(self.queue, self.raw, 0);
        }
    }
}
...
pub fn android_log(level: LogLevel, tag: &str, msg: &str) {
    ...
    unsafe {
        __android_log_write(
            level.to_android_prio(),
            tag_buf.as_ptr() as *const c_char,
...
pub unsafe fn post_frame_callback(callback: FrameCallback, data: *mut c_void) {
    ...
    if !ch.is_null() {
        AChoreographer_postFrameCallback(ch, Some(callback), data);
    }
}
...
mod tests {
    ...
    fn test_native_window_null() {
        unsafe {
            assert!(NativeWindow::from_raw(core::ptr::null_mut()).is_none());
        }
    }
    ...
    fn test_motion_action_down() {
        assert_eq!(
            MotionAction::from(AMOTION_EVENT_ACTION_DOWN),
            MotionAction::Down
        );
    }
    ...
    fn test_motion_action_up() {
        assert_eq!(
            MotionAction::from(AMOTION_EVENT_ACTION_UP),
            MotionAction::Up
        );
    }
    ...
    fn test_motion_action_move() {
        assert_eq!(
            MotionAction::from(AMOTION_EVENT_ACTION_MOVE),
            MotionAction::Move
        );
    }
    ...
    fn test_motion_action_cancel() {
        assert_eq!(
            MotionAction::from(AMOTION_EVENT_ACTION_CANCEL),
            MotionAction::Cancel
        );
    }
    ...
    fn test_motion_action_pointer_down() {
        assert_eq!(
            MotionAction::from(AMOTION_EVENT_ACTION_POINTER_DOWN),
    ...
    fn test_motion_action_pointer_up() {
        assert_eq!(
            MotionAction::from(AMOTION_EVENT_ACTION_POINTER_UP),
    ...
    fn test_motion_action_mask() {
        ...
        assert_eq!(
            MotionAction::from(action_with_pointer),
            MotionAction::PointerDown
        );
    }
